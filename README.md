...
An example of Kafka producer, consumer and Kafka Streams transformer.
...
First, you have to download and install ZooKeeper then download and install Kafka then install producer, consumer and transformer. Joke!
